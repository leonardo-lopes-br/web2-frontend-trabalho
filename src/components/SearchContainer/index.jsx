...
function SearchContainer() {
    ...
    useEffect(() => {
        const currentFilter = filterItems.filter(item => item.id === filterSelected)[0]
    ...
    return (
        <div className={styles.searchFieldContainer}>
            ...
            <div className={styles.searchInputContainer}>
                <input type="text" name="searchInput" id="searchInput" placeholder='Pesquisar na CineVortex' />
